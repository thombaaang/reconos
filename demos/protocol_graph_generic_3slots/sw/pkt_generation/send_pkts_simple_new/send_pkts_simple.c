...
// reverse byte order (src: http://stackoverflow.com/questions/2182002/convert-big-endian-to-little-endian-in-c-without-using-provided-func)
...
int main(int argc, char **argv)
{
	...
	// reverse the byte order (because memcpy inverts the byte order due to different endianness in memory (long unsigned int is assumed to be big-endian, memory is little-endian))
	// http://www.cplusplus.com/forum/general/6994/
	hash = swap_uint64(hash);
	// set hash value
