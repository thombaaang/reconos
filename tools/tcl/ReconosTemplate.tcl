...
#set proj_dir "C:/Users/meise/Vivado/ReconosTemplate"
set proj_dir "/home/meise/vivado_projects/ReconosTemplate"

#set reconos_ip "C:/reconos"
set reconos_ip "/home/meise/git/reconos_zynq/reconos/demos/sort_demo_vivado/build.hw/pcores"

# Set the directory path for the original project from where this script was exported
#set orig_proj_dir "[file normalize "$origin_dir/ReconosTemplate"]"

# Create project
create_project -force ReconosTemplate $proj_dir -part xc7z020clg484-1
...
set_property  ip_repo_paths  $reconos_ip [current_project]
update_ip_catalog
...
connect_bd_net [get_bd_pins reconos_proc_control_0/PROC_Pgf_Int] [get_bd_pins xlconcat_0/In0]
connect_bd_net [get_bd_pins reconos_osif_intc_0/OSIF_INTC_Out] [get_bd_pins xlconcat_0/In1]
...
create_bd_addr_seg -range 64K -offset 0x7b400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs {timer_0/S_AXI/reg0 }] SEG3
create_bd_addr_seg -range 64K -offset 0x69e00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs {reconos_osif_intc_0/S_AXI/reg0 }] SEG4
create_bd_addr_seg -range 64K -offset 0x64a00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs {reconos_clock_0/S_AXI/reg0 }] SEG5
...
#assign_bd_address [get_bd_addr_segs {reconos_proc_control_0/S_AXI/reg0 }]
#set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_proc_control_0_reg0}]
#set_property offset 0x6FE00000 [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_proc_control_0_reg0}]

#assign_bd_address [get_bd_addr_segs {reconos_osif_0/S_AXI/reg0 }]
#set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_osif_0_reg0}]
#set_property offset 0x75A00000 [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_osif_0_reg0}]

#assign_bd_address [get_bd_addr_segs {timer_0/S_AXI/reg0 }]
#set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_timer_0_reg0}]
#set_property offset 0x64A00000 [get_bd_addr_segs {processing_system7_0/Data/SEG_timer_0_reg0}]

#assign_bd_address [get_bd_addr_segs {reconos_osif_intc_0/S_AXI/reg0 }]
#set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_osif_intc_0_reg0}]
#set_property offset 0x7B400000 [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_osif_intc_0_reg0}]

#assign_bd_address [get_bd_addr_segs {reconos_clock_0/S_AXI/reg0 }]
#set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_clock_0_reg0}]
#set_property offset 0x69E00000 [get_bd_addr_segs {processing_system7_0/Data/SEG_reconos_clock_0_reg0}]
...
make_wrapper -files [get_files $proj_dir/ReconosTemplate.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse $proj_dir/ReconosTemplate.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
#set_property top "$proj_dir/ReconosTemplate.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" [current_fileset]
set_property top design_1_wrapper [current_fileset]

# create bitstream
#launch_runs impl_1 -to_step write_bitstream -jobs 2

# open implemented design - problem: called to early since launch_runs runs in background
# doesn't need to be called anymway, as Vivado offers a GUI dialog after implementation anyway
#open_run impl_1
