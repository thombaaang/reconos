...
#define RECONOS_PROC_CONTROL_SET_IC_SIG        _IOW(RECONOS_IOC_MAGIC, 13, int)
#define RECONOS_PROC_CONTROL_GET_IC_RDY        _IOR(RECONOS_IOC_MAGIC, 14, int)
#define RECONOS_PROC_CONTROL_SET_IC_RST        _IOW(RECONOS_IOC_MAGIC, 15, int)
