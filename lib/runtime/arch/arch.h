...
extern int reconos_osif_open(uint32_t ctrl_mask, uint32_t ctrl_bits);
extern ssize_t reconos_osif_read(int fd, uint32_t *buf, size_t count);
extern ssize_t reconos_osif_write(int fd, uint32_t *buf, size_t count);
